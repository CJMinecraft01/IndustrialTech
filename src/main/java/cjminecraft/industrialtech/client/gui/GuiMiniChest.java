...
public class GuiMiniChest extends GuiContainer {
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
	    ...
	    this.mc.getTextureManager().bindTexture(new ResourceLocation("industrialtech:textures/gui/container/minichest.png"));
	...
	protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
	    ...
	    this.fontRendererObj.drawString(this.playerInv.getDisplayName().getUnformattedText(), 8, 30, 4210752);      //#404040
	}
